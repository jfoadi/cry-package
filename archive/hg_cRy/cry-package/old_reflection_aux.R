sysabs  <- function(hkl,sym_number,setting)
{
 ...
 if (sym_number == 63)
 {
  ...
  if (setting == 2) hkl[hkl[,1] == 0 & hkl[,3]%%2 != 0,3] <- NA
  if (setting == 3) hkl[hkl[,3] == 0 & hkl[,1]%%2 != 0,3] <- NA
  if (setting == 4) hkl[hkl[,2] == 0 & hkl[,1]%%2 != 0,3] <- NA
  if (setting == 5) hkl[hkl[,1] == 0 & hkl[,2]%%2 != 0,3] <- NA
  if (setting == 6) hkl[hkl[,3] == 0 & hkl[,2]%%2 != 0,3] <- NA
  if (setting == 1 | setting == 2) hkl[(hkl[,1]+hkl[,2])%%2 != 0,3] <- NA
  if (setting == 3 | setting == 4) hkl[(hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
  if (setting == 5 | setting == 6) hkl[(hkl[,1]+hkl[,3])%%2 != 0,3] <- NA
 }
 if (sym_number == 64)
 {
  if (setting == 1) 
 ...
 {
  if (setting == 1) hkl[(hkl[,1]+hkl[,2])%%2 != 0,3] <- NA
  if (setting == 2) hkl[(hkl[,2]+hkl[,l])%%2 != 0,3] <- NA
  if (setting == 3) hkl[(hkl[,1]+hkl[,l])%%2 != 0,3] <- NA
 }
 if (sym_number == 66)
 {
  if (setting == 1)
 ...
 if (sym_number == 68)
 {
  ...
  if (setting >= 1 & setting <= 4) hkl[(hkl[,1]+hkl[,2])%%2 != 0,3] <- NA
  if (setting >= 5 & setting <= 8) hkl[(hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
  if (setting >= 9 & setting <= 12) hkl[(hkl[,1]+hkl[,3])%%2 != 0,3] <- NA
 }
 if (sym_number == 69)
 {
  hkl[(hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 ...
 if (sym_number == 70)
 {
  hkl[hkl[,1] != 0 & hkl[,2] != 0 & hkl[,3] == 0 & (3*(hkl[,1]+hkl[,2]))%%4 != 0,3] <- NA
  hkl[hkl[,1] == 0 & hkl[,2] != 0 & hkl[,3] != 0 & (3*(hkl[,2]+hkl[,3]))%%4 != 0,3] <- NA
  hkl[hkl[,1] != 0 & hkl[,2] == 0 & hkl[,3] != 0 & (3*(hkl[,1]+hkl[,3]))%%4 != 0,3] <- NA
  hkl[(hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
  hkl[(hkl[,1]+hkl[,3])%%2 != 0,3] <- NA
  hkl[(hkl[,1]+hkl[,2])%%2 != 0,3] <- NA
 }
 ...
 if (sym_number == 76) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%4 != 0,3] <- NA
 if (sym_number == 77) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
 if (sym_number == 78) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%4 != 0,3] <- NA
 if (sym_number == 79) hkl[(hkl[,1]+hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 if (sym_number == 80) 
 {
  hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%4 != 0,3] <- NA
  hkl[(hkl[,1]+hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 }
 # Nothing to do for sym_number 81
 if (sym_number == 82) hkl[(hkl[,1]+hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 # Nothing to do for sym_number 83
 if (sym_number == 84) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
 if (sym_number == 85) hkl[hkl[,1] != 0 & hkl[,2] != 0 & hkl[,3] == 0 & (hkl[,1]+hkl[,2])%%2 != 0,3] <- NA
 if (sym_number == 86) 
 {
  hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
  hkl[hkl[,1] != 0 & hkl[,2] != 0 & hkl[,3] == 0 & (hkl[,1]+hkl[,2])%%2 != 0,3] <- NA
 }
 if (sym_number == 87) hkl[(hkl[,1]+hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 if (sym_number == 88)
 {
  hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%4 != 0,3] <- NA
  hkl[hkl[,1] != 0 & hkl[,2] != 0 & hkl[,3] == 0 & hkl[,1]%%2 != 0,3] <- NA
 ...
 if (sym_number == 91) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
 if (sym_number == 92)
 {
  hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
  hkl[hkl[,1] != 0 & hkl[,2] == 0 & hkl[,3] == 0 & hkl[,1]%%2 != 0,3] <- NA
 ...
 if (sym_number == 93) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
 if (sym_number == 94)
 {
  hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
  hkl[hkl[,1] != 0 & hkl[,2] == 0 & hkl[,3] == 0 & hkl[,1]%%2 != 0,3] <- NA
 ...
 if (sym_number == 95) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%4 != 0,3] <- NA
 if (sym_number == 96)
 {
  hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%4 != 0,3] <- NA
  hkl[hkl[,1] != 0 & hkl[,2] == 0 & hkl[,3] == 0 & hkl[,1]%%2 != 0,3] <- NA
 ...
 if (sym_number == 97) hkl[(hkl[,1]+hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 if (sym_number == 98)
 {
  hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%4 != 0,3] <- NA
  hkl[(hkl[,1]+hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 ...
 {
  hkl[hkl[,1] == 0 & hkl[,2] != 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
  hkl[hkl[,1] ==  hkl[,2] & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
  hkl[hkl[,1] != 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
 }
 if (sym_number == 104) 
 {
 ...
 if (sym_number == 107) hkl[(hkl[,1]+hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 if (sym_number == 108)
 {
  hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
  hkl[hkl[,1] == 0 & hkl[,2] != 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
 ...
 {
  hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%4 != 0,3] <- NA
  hkl[hkl[,1] == hkl[,2] & hkl[,3] != 0 & (2*hkl[,1]+hkl[,3])%%4 != 0,3] <- NA
  hkl[hkl[,1] != 0 & hkl[,2] == 0 & hkl[,3] != 0 & (hkl[,1]+hkl[,3])%%2 != 0,3] <- NA
  hkl[(hkl[,1]+hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 }
 if (sym_number == 110)
 ...
 if (sym_number == 112) hkl[hkl[,1] == hkl[,2] & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
 if (sym_number == 113)
 {
  hkl[hkl[,1] != 0 & hkl[,2] == 0 & hkl[,3] == 0 & hkl[,1]%%2 != 0,3] <- NA
  hkl[hkl[,1] == 0 & hkl[,2] != 0 & hkl[,3] == 0 & hkl[,2]%%2 != 0,3] <- NA
 ...
 if (sym_number == 119) hkl[(hkl[,1]+hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 if (sym_number == 120)
 {
  hkl[hkl[,1] == 0 & hkl[,2] != 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
  hkl[hkl[,1] != 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
 }
 if (sym_number == 121) hkl[(hkl[,1]+hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 if (sym_number == 122)
 {
  hkl[hkl[,1] == hkl[,2] & hkl[,3] != 0 & (2*hkl[,1]+hkl[,3])%%4 != 0,3] <- NA
  hkl[hkl[,1] == 0 & hkl[,2] != 0 & hkl[,3] == 0 & hkl[,2]%%2 != 0,3] <- NA
 ...
 if (sym_number == 139) hkl[(hkl[,1]+hkl[,2]+hkl[,3])%%2 != 0,3] <- NA
 if (sym_number == 140)
 {
  hkl[hkl[,1] == 0 & hkl[,2] != 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
  hkl[hkl[,1] != 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%2 != 0,3] <- NA
 ...
 if (sym_number == 144) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%3 != 0,3] <- NA
 if (sym_number == 145) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%3 != 0,3] <- NA
 if (sym_number == 146) 
 {
  if (setting == 1)
  {
   hkl[(-hkl[,1]+hkl[,2]+hkl[,3])%%3 != 0,3] <- NA
  }
 ...
 if (sym_number == 151) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%3 != 0,3] <- NA
 if (sym_number == 152) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%3 != 0,3] <- NA
 if (sym_number == 153) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%3 != 0,3] <- NA
 if (sym_number == 154) hkl[hkl[,1] == 0 & hkl[,2] == 0 & hkl[,3] != 0 & hkl[,3]%%3 != 0,3] <- NA
 if (sym_number == 155) 
 {
  if (setting == 1)
  {
