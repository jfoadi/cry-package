          ...
          definition=function(object)
                     {
                      ...
                      tmp <- createMergedReflectionFromScratch(cell,symmetry,max(sort(c(cell@a,cell@b,cell@c)))+100,max_reso)
...
createMergedReflectionFromScratch <- function(cell,symmetry,reso_min,reso_max)
{
